...
const PM = {
  ...
  mtn_ug:      { id: 'mtn_ug',      name: 'MTN Mobile Money', icon: '📱', type: 'mobile_money' as const, minDep: 1000, maxDep: 5000000,  instant: true },
  airtel_ug:   { id: 'airtel_ug',   name: 'Airtel Money',   icon: '📱', type: 'mobile_money' as const, minDep: 1000,  maxDep: 5000000,  instant: true },
...
export const ALLOWED_COUNTRIES: CountryConfig[] = [
  ...
  { code: 'UG', name: 'Uganda',          flag: '🇺🇬', currency: 'UGX', currencySymbol: 'USh', callingCode: '+256', defaultLang: 'sw', blocked: false, paymentMethods: [PM.mtn_ug, PM.airtel_ug] },
