...
export default function LoginPage() {
  ...
  const INPUT = 'w-full rounded-xl border border-white/10 bg-[#161616] px-4 py-3 text-sm text-white placeholder-white/20 outline-none transition-colors';
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div
            ...
            style={{ background: 'linear-gradient(135deg,#0778BD,#0560A0)', color: '#F5A623', borderColor: 'rgba(245,166,35,0.2)', boxShadow: '0 4px 20px rgba(7,120,189,0.5)' }}
          >
            CB
          </div>
          <h1 className="text-2xl font-black text-white">Welcome back</h1>
          <p className="mt-1 text-sm" style={{ color: '#666666' }}>Sign in to your Castle Bet account</p>
        </div>
        ...
        <div className="relative mb-5">
          ...
          <div className="relative flex justify-center">
            <span className="px-3 text-xs" style={{ background: '#0A0A0A', color: '#666666' }}>or sign in with email</span>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label className="text-xs font-bold" style={{ color: '#666666' }}>Password</label>
