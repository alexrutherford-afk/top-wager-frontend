    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-10" style={{ background: '#0D1117' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl text-base font-black border"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold" style={{ color: '#F5A623' }}>Forgot password?</Link>
              </div>
